...
describe('Task4', () => {
    ...
    it('should deploy', async () => {
        ...
        tb.writeNumber(4)
        tb.writeCell((new Builder()).storeStringTail("----abcdefghijklmnopqrstuvwxyz!@#$%^&*()_-=ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789" +
            "abcdefghijklmnopqrstuvwxyz!@#$%^&*()_-=ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789" +
            "abcdefghijklmnopqrstuvwxyz!@#$%^&*()_-=ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789" +
            "abcdefghijklmnopqrstuvwxyz!@#$%^&*()_-=ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789" +
            "abcdefghijklmnopqrstuvwxyz!@#$%^&*()_-=ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789" +
            "abcdefghijklmnopqrstuvwxyz!@#$%^&*()_-=ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789" +
            "abcdefghijklmnopqrstuvwxyz!@#$%^&*()_-=ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789").asCell())
